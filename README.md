About pytest-filter-subpackage
==============================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9958&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-filter-subpackage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-filter-subpackage` can be installed with:

```
conda install pytest-filter-subpackage
```

It is possible to list all of the versions of `pytest-filter-subpackage` available on your platform with:
